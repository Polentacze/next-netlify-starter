      ...
      {isPlaying ? ( 
        <div className="arena-viewport" ref={viewRef} onClick={handleViewportClick}> 
          ...
          <div className="infinite-ocean-world" style={{ transform: 'translate(' + (400 - playerPosition.x) + 'px, ' + (300 - playerPosition.y) + 'px)' }}> 
            ...
            <div style={{ width: `${evoTiers[activeTierIndex].scale}px`, position: 'relative', transform: 'rotate(' + playerRotation + 'deg)', transition: 'transform 0.04s linear', background: 'transparent', backgroundColor: 'transparent' }}> 
