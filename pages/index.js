...
export default function Home() {
  ...
  const [chatMessages, setChatMessages] = useState([
    { user: "System", text: "Stethacanthus Ability active! Hold mouse button down as a shark to trigger speed buff.", colorCode: "#ff4d4d" }
  ])
  ...
  useEffect(() => {
    ...
    const tick = setInterval(() => {
      ...
      setPlayerPosition((p) => {
        ...
        // DYNAMIC VELOCITY MODIFIER CALCULATION
        let maxSpeed = 4.8
        if (isAbilityActive) maxSpeed = 9.6 // Increases speed cap dynamically during hold buff state
