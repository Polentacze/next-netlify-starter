...
return (
  <div ...
<div style={{ padding: '2rem', color: '#FFFFFF', minHeight: '100vh', display: 'flex' }}> flexDirection: 'column', justifyContent: 'center', alignItems: 'center', backgroundColor: '#104E8B', position: 'relative', overflowX: 'hidden', userSelect: 'none' }}>
