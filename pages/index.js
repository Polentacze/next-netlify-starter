...
// 🍏 Hardcore Scarce Food Respawning (Tiny clumps & solitary dots)
  ...
  return (
 justifyContent: 'center', alignItems: 'center', backgroundImage: "url('/ocean-background.png')", backgroundSize: '100% 100%', backgroundPosition: 'bottom center', backgroundRepeat: 'no-repeat', minHeight: '100vh', position: 'relative', overflowX: 'hidden', userSelect: 'none' }}>
