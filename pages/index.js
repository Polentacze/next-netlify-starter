...
export default function Home() {
  ...
  // 🧬 BALANCED TIER MATRIX: Enforces 115px Stethacanthus progression width scaling
  const evoTiers = [
  ...
  // 💥 SINGLE BAR LUNGE ENGINE: Consumes strictly 1 boost asset block per click
  ...
  useEffect(() => {
    ...
    const handleKeyDown = (e) => {
      ...
      if (e.key.toLowerCase() === 'e') {
        ...
        // Automatically turns off ability tracking locks after 2 total boosts
        setTimeout(() => {
    ...
    const mm = (e) => {
      ...
      setPlayerPosition((p) => {
        ...
        // 🏁 WEIGHTED VELOCITY: Caps basic speed at 4.8 and multiplier lunge tracking sets at 1.5x
        let maxSpeed = 4.8
        if (isAbilityActive) maxSpeed = 7.2 
